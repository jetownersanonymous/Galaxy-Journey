...
//Name: Tile6.ma
//Last modified: Mon, Oct 06, 2014 12:14:55 AM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.55991360144525149 15.000024362945155 5.2312822970428119 ;
	setAttr ".r" -type "double3" -65.13835272971906 360.19999999997964 1.6151352641374341e-016 ;
...
createNode mesh -n "polySurfaceShape2" -p "polySurface5";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 20 ".pt";
	setAttr ".pt[3]" -type "float3" -1.4824322 0 0 ;
	setAttr ".pt[9]" -type "float3" -1.4824324 0 0 ;
	setAttr ".pt[17]" -type "float3" -1.4821792 0 0 ;
	setAttr ".pt[21]" -type "float3" -1.4821792 0 0 ;
	setAttr ".pt[31]" -type "float3" 1.4824322 0 0 ;
	setAttr ".pt[37]" -type "float3" 1.4824324 0 0 ;
	setAttr ".pt[45]" -type "float3" 1.4821792 0 0 ;
	setAttr ".pt[49]" -type "float3" 1.4821792 0 0 ;
	setAttr ".pt[57]" -type "float3" -1.4824322 0 0 ;
	setAttr ".pt[59]" -type "float3" -1.4824321 0 0 ;
	setAttr ".pt[63:66]" -type "float3" -1.4821789 0 0  3.7252903e-009 0 1.8626451e-009  
		-3.9872248e-008 -1.4901161e-008 -3.7252903e-008  -1.4821789 0 0 ;
	setAttr ".pt[69]" -type "float3" 1.4824322 0 0 ;
	setAttr ".pt[71:72]" -type "float3" 1.4824321 0 0  0 0 0 ;
	setAttr ".pt[75]" -type "float3" 1.4821789 0 0 ;
	setAttr ".pt[78]" -type "float3" 1.4821789 0 0 ;
