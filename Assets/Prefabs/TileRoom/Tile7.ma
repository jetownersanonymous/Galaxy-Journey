...
//Name: Tile7.ma
//Last modified: Mon, Oct 06, 2014 12:17:45 AM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.84043693342753378 14.320776968914641 6.7434703783534964 ;
	setAttr ".r" -type "double3" -61.538352729667409 1.3999999999463708 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.338554268791142;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.29188212557799043 100.12713443542476 -0.090791055120502673 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 4.1643383171866448;
...
createNode polyTweak -n "polyTweak8";
	setAttr ".uopa" yes;
	setAttr -s 20 ".tk";
	setAttr ".tk[3]" -type "float3" -1.4824322 0 0 ;
	setAttr ".tk[9]" -type "float3" -1.4824324 0 0 ;
	setAttr ".tk[17]" -type "float3" -1.4821792 0 0 ;
	setAttr ".tk[21]" -type "float3" -1.4821792 0 0 ;
	setAttr ".tk[31]" -type "float3" 1.4824322 0 0 ;
	setAttr ".tk[37]" -type "float3" 1.4824324 0 0 ;
	setAttr ".tk[45]" -type "float3" 1.4821792 0 0 ;
	setAttr ".tk[49]" -type "float3" 1.4821792 0 0 ;
	setAttr ".tk[57]" -type "float3" -1.4824322 0 0 ;
	setAttr ".tk[59]" -type "float3" -1.4824321 0 0 ;
	setAttr ".tk[63:66]" -type "float3" -1.4821789 0 0  3.7252903e-009 0 1.8626451e-009  
		-3.9872248e-008 -1.4901161e-008 -3.7252903e-008  -1.4821789 0 0 ;
	setAttr ".tk[69]" -type "float3" 1.4824322 0 0 ;
	setAttr ".tk[71:72]" -type "float3" 1.4824321 0 0  0 0 0 ;
	setAttr ".tk[75]" -type "float3" 1.4821789 0 0 ;
	setAttr ".tk[78]" -type "float3" 1.4821789 0 0 ;
createNode deleteComponent -n "deleteComponent7";
	setAttr ".dc" -type "componentList" 4 "f[53]" "f[57]" "f[62]" "f[66]";
createNode polyCloseBorder -n "polyCloseBorder4";
	setAttr ".ics" -type "componentList" 3 "e[15]" "e[99]" "e[106:107]";
createNode polyTweak -n "polyTweak9";
	setAttr ".uopa" yes;
	setAttr -s 33 ".tk";
	setAttr ".tk[4:8]" -type "float3" 0.32400838 0 0  0.32084757 0 0  0.32084757 
		0 0  0.32400838 0 0  0.32400838 0 0 ;
	setAttr ".tk[13]" -type "float3" 0.32400838 0 0 ;
	setAttr ".tk[22:27]" -type "float3" 0.3238422 0 0  0.32384223 0 0  0.32068309 
		0 0  0.32068309 0 0  0.32384217 0 0  0.32384217 0 0 ;
	setAttr ".tk[32:36]" -type "float3" -0.32400838 0 0  -0.32084757 0 0  -0.32084757 
		0 0  -0.32400838 0 0  -0.32400838 0 0 ;
	setAttr ".tk[41]" -type "float3" -0.32400838 0 0 ;
	setAttr ".tk[50:55]" -type "float3" -0.3238422 0 0  -0.32384223 0 0  -0.32068309 
		0 0  -0.32068309 0 0  -0.32384217 0 0  -0.32384217 0 0 ;
	setAttr ".tk[60:61]" -type "float3" 0.32400838 0 0  0.32084757 0 0 ;
	setAttr ".tk[64:65]" -type "float3" 0.32068309 0 0  0.32384217 0 0 ;
	setAttr ".tk[72:73]" -type "float3" -0.32400838 0 0  -0.32084757 0 0 ;
	setAttr ".tk[76:77]" -type "float3" -0.32068309 0 0  -0.32384217 0 0 ;
createNode groupParts -n "groupParts18";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:74]";
	setAttr ".gi" 59;
createNode polyCloseBorder -n "polyCloseBorder5";
	setAttr ".ics" -type "componentList" 4 "e[78]" "e[138]" "e[142]" "e[144]";
createNode groupParts -n "groupParts19";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:75]";
	setAttr ".gi" 60;
createNode polyCloseBorder -n "polyCloseBorder6";
	setAttr ".ics" -type "componentList" 3 "e[57]" "e[125]" "e[132:133]";
createNode groupParts -n "groupParts20";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0:76]";
	setAttr ".gi" 61;
createNode polyCloseBorder -n "polyCloseBorder7";
	setAttr ".ics" -type "componentList" 4 "e[47]" "e[112]" "e[116]" "e[118]";
...
connectAttr "polyCloseBorder5.out" "groupParts19.ig";
connectAttr "groupParts19.og" "polyCloseBorder6.ip";
connectAttr "polyCloseBorder6.out" "groupParts20.ig";
connectAttr "groupParts20.og" "polyCloseBorder7.ip";
connectAttr "polyCloseBorder7.out" "groupParts21.ig";
